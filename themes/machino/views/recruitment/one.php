...
?>
	...
	<div class="block">
		<div class="head head2">
			Заявка на вступление в клан <?php echo $recruitment->account->nickname ?> от <?php echo date('d.m.Y H:i', $recruitment->time+Yii::app()->params["moscow"]) ?>
			<div class="pull-right">
				<?php echo CHtml::link('&larr; Назад', array('/recruitment/index')); ?>
			</div>
		</div>
