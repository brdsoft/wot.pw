...
class ForumCategoriesController extends Controller
{
	...
	{
		$model=new ForumCategories('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['ForumCategories']))
	 ...
	 * @return ForumCategories the loaded model
	 ...
	 * @param ForumCategories $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='forum-categories-form')
		{
