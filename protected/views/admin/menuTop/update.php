...
<h2><a href="/admin"><?php echo Yii::t('wot', 'Admin Panel')?></a> <span class="rarr"></span> <?php echo CHtml::link(Yii::t('wot', 'Top Menu'), array('admin')) ?> <span class="rarr"></span> <?php echo Yii::t('wot', 'Edit Menu Item')?> #<?php echo $model->id; ?></h2>
