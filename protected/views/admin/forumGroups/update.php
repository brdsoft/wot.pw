<?php
$this->pageTitle=Yii::t('wot', 'Admin Panel').' — '.Yii::t('wot', 'Edit Category');
?>

<h2><a href="/admin"><?php echo Yii::t('wot', 'Admin Panel')?></a> <span class="rarr"></span> <?php echo CHtml::link(Yii::t('wot', 'Forum Categories'), array('admin')) ?> <span class="rarr"></span> <?php echo Yii::t('wot', 'Edit Category')?> #<?php echo $model->id; ?></h2>
