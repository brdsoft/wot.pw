<?php
$this->pageTitle=Yii::t('wot', 'Admin Panel - Company Editor');
?>

<h2><a href="/admin"><?php echo Yii::t('wot', 'Admin Panel')?></a> <span class="rarr"></span> <?php echo CHtml::link(Yii::t('wot', 'Companies'), array('admin')) ?> <span class="rarr"></span> <?php echo Yii::t('wot', 'Edit company')?> &laquo;<?php echo $model->name; ?>&raquo;</h2>
