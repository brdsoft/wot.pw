<?php
$this->pageTitle=Yii::t('wot', 'Admin Panel -  Static pages');
?>

<h2><a href="/admin"><?php echo Yii::t('wot', 'Admin Panel')?></a> <span class="rarr"></span> <?php echo Yii::t('wot', 'Static pages')?></h2>
			...
			<?php $this->widget('zii.widgets.grid.CGridView', array(
                ...
                'columns'=>array(
                    ...
                    array(
                        ...
                        'type'=>'html',
                        'value'=>'CHtml::link("/page/".$data->name, array("/page/index", "id"=>$data->name))',
                    ),
                    array(
