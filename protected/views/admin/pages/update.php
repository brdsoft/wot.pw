<?php
$this->pageTitle=Yii::t('wot', 'Admin Panel - Page Editor');
?>

<h2><a href="/admin"><?php echo Yii::t('wot', 'Admin Panel')?></a> <span class="rarr"></span> <?php echo CHtml::link(Yii::t('wot', 'Static pages'), array('admin')) ?> <span class="rarr"></span> <?php echo Yii::t('wot', 'Edit Page')?> <?php echo $model->name; ?></h2>
