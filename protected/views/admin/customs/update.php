...
<h2><a href="/admin"><?php echo Yii::t('wot', 'Admin Panel')?></a> <span class="rarr"></span> <?php echo CHtml::link(Yii::t('wot', 'HTML Pages'), array('admin')) ?> <span class="rarr"></span> <?php echo Yii::t('wot', 'Edit Page')?> <?php echo $model->name; ?></h2>
