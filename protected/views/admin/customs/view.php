...
<h2><a href="/admin"><?php echo Yii::t('wot', 'Admin Panel')?></a> <span class="rarr"></span> <?php echo CHtml::link(Yii::t('wot', 'HTML Pages'), array('admin')) ?> <span class="rarr"></span> <?php echo Yii::t('wot', 'View Page')?> <?php echo $model->name; ?></h2>
		...
		<div class="filling">
			...
			<?php $this->widget('zii.widgets.CDetailView', array(
				...
				'attributes'=>array(
					...
					'type'=>'html',
					'value'=>CHtml::link('http://'.$this->site->url.'/custom/'.$model->name, array('/custom/index', 'id'=>$model->name)),
					),
				),
			)); ?>
