<?php
$this->pageTitle=Yii::t('wot', 'Admin Panel').' — '.Yii::t('wot', 'Edit Restriction');
?>

<h2><a href="/admin"><?php echo Yii::t('wot', 'Admin Panel')?></a> <span class="rarr"></span> <?php echo CHtml::link(Yii::t('wot', 'Access Restriction'), array('admin')) ?> <span class="rarr"></span> <?php echo Yii::t('wot', 'Edit Restriction')?>  #<?php echo $model->id; ?></h2>
